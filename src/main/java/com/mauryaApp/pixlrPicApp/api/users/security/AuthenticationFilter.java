...
import com.mauryaApp.pixlrPicApp.api.users.model.LoginRequestModel;
...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter{
	...
	public AuthenticationFilter(UsersService usersService, Environment environment, AuthenticationManager authManger) {
	...
	protected void successfulAuthentication(HttpServletRequest request, 
		...
		String token = Jwts.builder()
						...
						.signWith(io.jsonwebtoken.SignatureAlgorithm.HS512, environment.getProperty("token.secret"))
						.compact();
